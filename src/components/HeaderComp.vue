<template>
  <div>
    <v-row
        ...
        class="bg-cyan-accent-4 pt-10 justify-space-around pb-5">
      <v-btn class="">Главная</v-btn>
      <v-btn>Список курсов</v-btn>
      <v-btn>Настройки</v-btn>
      <div class="d-flex  mt-md-n2">
        ...
        <a class="align-self-center  ml-10" href="#">User Name</a>
      </div>
    </v-row>
  </div>
</template>
